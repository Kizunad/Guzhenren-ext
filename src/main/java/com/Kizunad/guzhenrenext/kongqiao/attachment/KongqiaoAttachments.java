...
public final class KongqiaoAttachments {
    ...
    public static final DeferredHolder<
        AttachmentType<?>,
        AttachmentType<com.Kizunad.guzhenrenext.kongqiao.flyingsword.training.FlyingSwordTrainingAttachment>
    > FLYING_SWORD_TRAINING =
        ATTACHMENT_TYPES.register(
            "flying_sword_training",
            () ->
                AttachmentType.serializable(
                        com.Kizunad.guzhenrenext.kongqiao.flyingsword.training.FlyingSwordTrainingAttachment::new
                    )
                    .copyOnDeath()
                    .build()
        );
    ...
    public static com.Kizunad.guzhenrenext.kongqiao.flyingsword.training
        .FlyingSwordTrainingAttachment getFlyingSwordTraining(Entity entity) {
        if (entity == null) {
            return null;
        }
        if (!entity.hasData(FLYING_SWORD_TRAINING.get())) {
            entity.setData(
                FLYING_SWORD_TRAINING.get(),
                new com.Kizunad.guzhenrenext.kongqiao.flyingsword.training
                    .FlyingSwordTrainingAttachment()
            );
        }
