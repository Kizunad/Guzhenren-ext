...
/**
 * 雷道主动：电浆场（覆盖地面）- 在目标位置生成短暂电浆领域，触碰者被麻痹减速。
 * <p>
 * 该技能不直接输出高额伤害，更多提供控场与逼位，符合“电浆蛊攻击力并不强”的设定。
 * </p>
 */
public class LeiDaoActivePlasmaFieldEffect implements IGuEffect {
    ...
    private static final float MAX_CLOUD_RADIUS = 10.0F;

    private static final int DEFAULT_CLOUD_DURATION_TICKS = 120;
    ...
    public LeiDaoActivePlasmaFieldEffect(
