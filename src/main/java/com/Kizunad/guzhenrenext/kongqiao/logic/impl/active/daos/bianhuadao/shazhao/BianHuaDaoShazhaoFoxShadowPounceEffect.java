...
/**
 * 变化道主动杀招【狐影扑杀】：锁定单体，造成普通伤害并附带短暂迟缓。
 * <p>
 * 说明：使用普通伤害源，受护甲影响，避免法术伤害穿甲过强。
 * </p>
 */
public class BianHuaDaoShazhaoFoxShadowPounceEffect implements IShazhaoActiveEffect {

    public static final String SHAZHAO_ID =
        "guzhenrenext:shazhao_active_bian_hua_fox_shadow_pounce";
    ...
    private static final String NBT_COOLDOWN_KEY =
        "guzhenrenext_shazhao_active_bian_hua_fox_shadow_pounce_cd_until";
    ...
    public boolean onActivate(final ServerPlayer player, final ShazhaoData data) {
        ...
        applyKnockback(player, target, data);
