 ...
 * </p>
 */
public class RenDaoActiveTargetHealEffect implements IGuEffect {
    ...
    public RenDaoActiveTargetHealEffect(
        ...
        this.extraEffects = extraEffects == null
            ? List.of()
            : List.copyOf(extraEffects);
    }
