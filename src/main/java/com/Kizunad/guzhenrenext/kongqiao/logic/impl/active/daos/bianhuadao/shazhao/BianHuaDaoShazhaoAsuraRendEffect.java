...
/**
 * 变化道主动杀招【修罗裂杀】：锁定强敌，主目标高额普通伤害并溅射周围。
 * <p>
 * 说明：溅射与控制都做倍率裁剪，避免持续时间离谱；伤害倍率允许很大以体现高转上限。
 * </p>
 */
public class BianHuaDaoShazhaoAsuraRendEffect implements IShazhaoActiveEffect {

    public static final String SHAZHAO_ID =
        "guzhenrenext:shazhao_active_bian_hua_asura_rend";
    ...
    private static final String META_PRIMARY_PHYSICAL_DAMAGE = "primary_physical_damage";
    private static final String META_SPLASH_PHYSICAL_DAMAGE = "splash_physical_damage";
    ...
    private static final double DEFAULT_SPLASH_RADIUS = 5.0;
    ...
    private static final String NBT_COOLDOWN_KEY =
        "guzhenrenext_shazhao_active_bian_hua_asura_rend_cd_until";
    ...
    public boolean onActivate(final ServerPlayer player, final ShazhaoData data) {
        ...
        applyWeakness(target, data, primaryMultiplier);
        applyKnockback(player, target, data, primaryMultiplier);
        ...
        if (splashBase > 0.0 && radius > MIN_RADIUS) {
            applySplashDamage(player, target, source, splashBase, radius);
        }
