...
/**
 * 毒道被动：受击触发（概率）- 毒体卸力（减伤）+ 可选自我增益。
 * <p>
 * 毒道的“防御”更多体现在抗性与卸力：用减伤作为通用实现，且减伤随毒道道痕放大但存在上限，
 * 避免极端道痕导致接近免伤。
 * </p>
 */
public class DuDaoHurtProcReductionEffect implements IGuEffect {
    ...
    public DuDaoHurtProcReductionEffect(
