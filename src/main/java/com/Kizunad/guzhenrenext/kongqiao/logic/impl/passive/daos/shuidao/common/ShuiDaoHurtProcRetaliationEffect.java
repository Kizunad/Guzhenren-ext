...
/**
 * 水道被动：受击触发（概率）- 反制水波（普通伤害）+ 施加减益。
 * <p>
 * 反制伤害同样走普通伤害来源，受护甲影响，避免穿透过强。
 * </p>
 */
public class ShuiDaoHurtProcRetaliationEffect implements IGuEffect {
    ...
    public ShuiDaoHurtProcRetaliationEffect(
