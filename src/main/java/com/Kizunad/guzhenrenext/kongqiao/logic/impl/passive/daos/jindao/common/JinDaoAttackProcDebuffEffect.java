...
/**
 * 金道被动：攻击触发（概率）附带负面效果，并可追加少量普通伤害。
 * <p>
 * 注意：金道法术伤害穿透护甲过强，因此默认仅使用普通伤害；保留字段仅用于兼容，建议不配置。
 * </p>
 */
public class JinDaoAttackProcDebuffEffect implements IGuEffect {
    ...
    public JinDaoAttackProcDebuffEffect(
    ...
    public float onAttack(
        ...
        if (extraPhysicalDamage > 0.0) {
            ...
            target.hurt(attacker.damageSources().magic(), (float) (extraMagicDamage * multiplier));
        }
