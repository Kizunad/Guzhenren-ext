...
/**
 * 变化道被动杀招【龟息回元】：以龟息之法回养精力与魂魄（持续维持）。
 * <p>
 * 说明：恢复量属于非伤害类数值，按倍率裁剪，避免随道痕无限膨胀。
 * </p>
 */
public class BianHuaDaoShazhaoTurtleBreathRegenEffect implements IShazhaoEffect {

    public static final String SHAZHAO_ID =
        "guzhenrenext:shazhao_passive_bian_hua_turtle_breath_regen";
    ...
    private static final String META_HUNPO_GAIN_PER_SECOND =
        "hunpo_gain_per_second";

    private static final double DEFAULT_JINGLI_GAIN_PER_SECOND = 0.10;
    private static final double DEFAULT_HUNPO_GAIN_PER_SECOND = 0.03;
