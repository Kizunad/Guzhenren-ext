...
/**
 * 星道通用被动：受伤触发（概率）减伤，并可附带“闪避挪移”或短暂自增益。
 * <p>
 * - 资源消耗：真元折算 +（念头/精力/魂魄任选其一即可），触发时仅扣一次。
 * - 概率/减伤/位移距离/增益持续时间：随星道道痕动态变化（倍率裁剪防止失控）。
 * </p>
 */
public class XingDaoHurtProcReductionEffect implements IGuEffect {
    ...
    public XingDaoHurtProcReductionEffect(
