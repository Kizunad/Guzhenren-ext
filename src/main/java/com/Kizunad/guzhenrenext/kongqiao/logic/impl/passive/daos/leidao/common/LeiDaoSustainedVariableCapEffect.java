...
/**
 * 雷道高转被动：持续维持（多资源）+ 提升 Guzhenren 字段上限。
 * <p>
 * 用于三转及以上的“上限型”辅助：提升真元/精力/魂魄/魂魄抗性上限等，且会随雷道道痕变化。
 * </p>
 *
 * <p>metadata:</p>
 * <ul>
 ...
 * </ul>
 */
public class LeiDaoSustainedVariableCapEffect implements IGuEffect {
    ...
    public LeiDaoSustainedVariableCapEffect(
