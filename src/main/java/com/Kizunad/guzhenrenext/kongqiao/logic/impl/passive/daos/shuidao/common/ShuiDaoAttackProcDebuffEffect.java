...
/**
 * 水道被动：攻击触发（概率）- 施加减益 + 附加普通伤害。
 * <p>
 * 设计目标：水道以“卸力/牵制/持续压制”为主，伤害尽量走普通伤害来源（受护甲影响），
 * 避免法术伤害穿透护甲过强导致的平衡问题。
 * </p>
 *
 * <p>metadata:</p>
 ...
 * </ul>
 */
public class ShuiDaoAttackProcDebuffEffect implements IGuEffect {
    ...
    public ShuiDaoAttackProcDebuffEffect(
