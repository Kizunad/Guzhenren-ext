...
/**
 * 水道主动：指向打击 - 单体/小范围的普通伤害 + 可选减益。
 * <p>
 * 统一实现多个水道主动技能：通过 metadata 配置伤害、范围与 AoE。
 * </p>
 */
public class ShuiDaoActiveTargetStrikeEffect implements IGuEffect {
    ...
    public ShuiDaoActiveTargetStrikeEffect(
