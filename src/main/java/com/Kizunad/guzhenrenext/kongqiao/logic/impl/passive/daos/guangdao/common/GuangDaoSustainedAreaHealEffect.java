...
/**
 * 光道通用被动：持续性维持（多资源）+ 群体疗愈/回复（随光道道痕动态变化）。
 * <p>
 * 通过 metadata 配置：<br>
 ...
 * </p>
 */
public class GuangDaoSustainedAreaHealEffect implements IGuEffect {
    ...
    public GuangDaoSustainedAreaHealEffect(final String usageId) {
