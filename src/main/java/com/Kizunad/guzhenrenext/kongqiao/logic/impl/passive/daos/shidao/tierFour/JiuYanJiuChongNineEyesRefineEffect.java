 ...
 * 四转九眼酒虫：被动【九眼观元】。
 * <p>
 * 设计目标：高转酒虫的“精炼小境界”落地为强续航：以饱和换真元，并附带少量念头补给。</p>
 */
public class JiuYanJiuChongNineEyesRefineEffect implements IGuEffect {

    public static final String USAGE_ID =
        "guzhenren:jiuyanjiuchong_passive_nine_eyes_refine";
    ...
    private static final int DEFAULT_MIN_HUNGER = 8;
    private static final double DEFAULT_SAT_COST = 0.3;
    private static final double DEFAULT_ZHENYUAN_GAIN = 10.0;
    private static final double DEFAULT_NIANTOU_REGEN = 0.08;
