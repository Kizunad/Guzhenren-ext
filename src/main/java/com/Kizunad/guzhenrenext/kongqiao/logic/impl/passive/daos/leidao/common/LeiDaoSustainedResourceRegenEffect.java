...
/**
 * 雷道被动：雷池蓄电（持续恢复念头/精力/魂魄/真元），并受雷道道痕缩放。
 * <p>
 * 设计意图：以雷意淬神、以电机活窍，提供雷道的基础续航补给通路，避免流派缺失资源恢复能力。
 */
public class LeiDaoSustainedResourceRegenEffect implements IGuEffect {
    ...
    public LeiDaoSustainedResourceRegenEffect(final String usageId) {
