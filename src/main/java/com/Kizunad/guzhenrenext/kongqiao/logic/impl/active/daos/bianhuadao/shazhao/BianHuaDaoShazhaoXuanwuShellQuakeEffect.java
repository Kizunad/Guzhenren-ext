...
/**
 * 变化道主动杀招【玄武震踏】：重躯落地，震荡周身敌人（范围普通伤害 + 迟缓 + 击退）。
 */
public class BianHuaDaoShazhaoXuanwuShellQuakeEffect implements IShazhaoActiveEffect {

    public static final String SHAZHAO_ID =
        "guzhenrenext:shazhao_active_bian_hua_xuanwu_shell_quake";
    ...
    private static final String NBT_COOLDOWN_KEY =
        "guzhenrenext_shazhao_active_bian_hua_xuanwu_shell_quake_cd_until";
