...
/**
 * 金道被动：金精养窍（持续恢复念头/精力/魂魄/真元），并受金道道痕缩放。
 * <p>
 * 设计意图：金精入窍，骨肉坚固；以“金精反哺”提供金道的基础续航补给通路，避免流派缺失资源恢复能力。
 */
public class JinDaoSustainedResourceRegenEffect implements IGuEffect {
    ...
    public JinDaoSustainedResourceRegenEffect(final String usageId) {
