 ...
 * 二转大智蛊：被动【智算】。
 * <p>
 * 设计目标：维持开启后，持续消耗真元，并为“杀招推演”提供加成（由主动【智推】读取）。
 * 与大慧蛊侧重“增益推演”，大智蛊侧重“择优推演”，故默认加成略低，但更稳定。
 * </p>
 */
public class DaZhiGuWisdomStrategyEffect implements IGuEffect {

    public static final String PASSIVE_USAGE_ID =
        "guzhenren:dazhigu_passive_wisdom_strategy";

    private static final String ITEM_ID = "guzhenren:dazhigu";

    private static final double DEFAULT_ZHENYUAN_BASE_COST_PER_SECOND = 6.4;
    private static final double DEFAULT_CHANCE_BONUS = 0.05;
    private static final double DEFAULT_FAIL_COST_MULTIPLIER = 0.80;
