...
/**
 * 毒道主动：指向打击 - 单体/小范围的普通伤害 + 可选减益（毒道道痕缩放）。
 * <p>
 * 统一实现多个毒道主动技能：通过 metadata 配置伤害、范围与 AoE。
 * </p>
 */
public class DuDaoActiveTargetStrikeEffect implements IGuEffect {
    ...
    public DuDaoActiveTargetStrikeEffect(
