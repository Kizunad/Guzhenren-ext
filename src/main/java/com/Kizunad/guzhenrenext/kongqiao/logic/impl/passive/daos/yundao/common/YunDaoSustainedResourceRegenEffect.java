...
/**
 * 云道被动：云息润养（持续恢复念头/精力/魂魄/真元），并受云道道痕缩放。
 * <p>
 * 设计意图：云息绵长，润物无声；作为云道的基础续航补给通路，避免流派缺失资源恢复能力。
 */
public class YunDaoSustainedResourceRegenEffect implements IGuEffect {
    ...
    public YunDaoSustainedResourceRegenEffect(final String usageId) {
