...
/**
 * 奴道主动：视线锁定单体目标的“兽令打击”（优先普通伤害）。
 * <p>
 * 设计目标：
 * <ul>
 *   <li>伤害走普通伤害通道，避免法术穿甲过强。</li>
 *   <li>伤害/负面效果强度接入奴道道痕算法。</li>
 *   <li>资源消耗统一走 {@link GuEffectCostHelper}（真元按标准折算）。</li>
 * </ul>
 * </p>
 */
public class NuDaoActiveTargetNukeEffect implements IGuEffect {
    ...
    public NuDaoActiveTargetNukeEffect(
