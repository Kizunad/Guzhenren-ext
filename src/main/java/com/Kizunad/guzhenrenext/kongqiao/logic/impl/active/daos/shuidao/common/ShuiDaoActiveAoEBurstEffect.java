...
/**
 * 水道主动：范围潮击 - 对周围目标造成普通伤害并施加减益。
 * <p>
 * 主要用于“洪水/水瀑/重水”等偏控场技能：伤害是普通伤害，控制为主。
 * </p>
 */
public class ShuiDaoActiveAoEBurstEffect implements IGuEffect {
    ...
    public ShuiDaoActiveAoEBurstEffect(
