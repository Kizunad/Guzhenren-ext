...
/**
 * 毒道被动：攻击触发（概率）- 施加减益 + 可选附加普通伤害。
 * <p>
 * 设计目标：毒道以“削弱/消磨/延迟爆发”为主，伤害尽量使用普通伤害（受护甲影响），
 * 避免法术伤害穿透护甲过强导致的平衡问题。
 * </p>
 *
 * <p>metadata:</p>
 ...
 * </ul>
 */
public class DuDaoAttackProcDebuffEffect implements IGuEffect {
    ...
    public DuDaoAttackProcDebuffEffect(
