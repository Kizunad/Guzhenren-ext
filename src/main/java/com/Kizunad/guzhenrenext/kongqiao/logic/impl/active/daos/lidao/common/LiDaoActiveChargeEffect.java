...
/**
 * 力道主动：突进冲撞（位移 + 前方命中伤害/控场），受力道道痕缩放。
 * <p>
 * 位移与命中判定在同一 tick 内完成，避免复杂持续碰撞导致的同步问题。
 * </p>
 */
public class LiDaoActiveChargeEffect implements IGuEffect {
    ...
    public LiDaoActiveChargeEffect(
