...
/**
 * 木道主动：范围爆发（优先普通伤害），并可附带一个负面效果与轻微击退。
 * <p>
 * 需求约束：
 * <ul>
 *   <li>真元消耗必须走 {@link com.Kizunad.guzhenrenext.guzhenrenBridge.ZhenYuanHelper#calculateGuCost}</li>
 *   <li>效果强度需接入道痕算法（木道）</li>
 *   <li>法术伤害穿甲过强，默认优先普通伤害</li>
 * </ul>
 */
public class MuDaoActiveAoEBurstEffect implements IGuEffect {
    ...
    public MuDaoActiveAoEBurstEffect(
