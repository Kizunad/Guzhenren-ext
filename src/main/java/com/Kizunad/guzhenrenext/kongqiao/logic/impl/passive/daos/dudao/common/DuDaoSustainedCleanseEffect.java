...
/**
 * 毒道通用被动：持续维持（多资源）+ 自身净化（清除负面效果）。
 * <p>
 * 典型用途：吞毒蛙等“解毒”蛊虫；每秒清除少量有害效果，受毒道道痕影响（上限保护）。
 * </p>
 *
 * <p>metadata:</p>
 * <ul>
 ...
 * </ul>
 */
public class DuDaoSustainedCleanseEffect implements IGuEffect {
    ...
    public DuDaoSustainedCleanseEffect(final String usageId) {
