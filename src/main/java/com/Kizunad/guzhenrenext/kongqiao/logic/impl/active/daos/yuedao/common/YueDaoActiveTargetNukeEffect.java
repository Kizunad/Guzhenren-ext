package com.Kizunad.guzhenrenext.kongqiao.logic.impl.active.daos.yuedao.common;
...
/**
 * 月道主动：锁定目标的单体打击（优先普通伤害）+ 可选附带多个负面效果。
 */
public class YueDaoActiveTargetNukeEffect implements IGuEffect {
    ...
    public YueDaoActiveTargetNukeEffect(
