...
/**
 * 星道通用被动：持续性维持（多资源）+ 状态效果（药水效果）。
 * <p>
 * - 资源消耗：由 metadata 指定（含真元折算、念头/精力/魂魄等）。
 * - 效果持续时间：随星道道痕动态变化（倍率裁剪防止失控）。
 * </p>
 */
public class XingDaoSustainedMobEffectEffect implements IGuEffect {
    ...
    public XingDaoSustainedMobEffectEffect(
