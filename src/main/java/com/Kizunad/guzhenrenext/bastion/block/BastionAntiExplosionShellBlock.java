 ...
 * 反爆外壳节点方块。
 * <p>
 * Round 28：挂载在 Anchor 上，为基地提供爆炸保护（配合事件监听实现范围免疫）。
 * </p>
 */
public class BastionAntiExplosionShellBlock extends Block {

    public BastionAntiExplosionShellBlock(Properties properties) {
        super(properties);
    }
