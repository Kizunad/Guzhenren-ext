...
public interface IGoal {
     ...
     */
    default com.Kizunad.customNPCs.ai.planner.WorldState getDesiredState(
        INpcMind mind,
        LivingEntity entity
    ) {
        return null;
    ...
    default java.util.List<
        com.Kizunad.customNPCs.ai.planner.IGoapAction
    > getAvailableActions(INpcMind mind, LivingEntity entity) {
