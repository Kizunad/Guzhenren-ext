...
public class IdleGoal implements IGoal {
    ...
    public void start(INpcMind mind, LivingEntity entity) {
        ...
        System.out.println("[IdleGoal] NPC " + entity.getName().getString() + " 开始闲逛");
    }
    ...
    public void tick(INpcMind mind, LivingEntity entity) {
        ...
        if (idleTicks % IDLE_TICK_INTERVAL == 0) {
            System.out.println("[IdleGoal] NPC " + entity.getName().getString() 
                + " 正在闲逛... (" + idleTicks + " ticks)");
        }
    }
    ...
    public void stop(INpcMind mind, LivingEntity entity) {
        ...
        System.out.println("[IdleGoal] NPC " + entity.getName().getString() + " 停止闲逛");
    }
